<div class="page-content">
   ...
   <div class="card radius-10 border-start border-0 border-3 border-danger">
      <div class="card-body">
         <div class="d-flex align-items-center">
            <div>
               <p class="mb-0 text-secondary">Villes</p>
               <h4 class="my-1 text-danger">06</h4>
               <p class="mb-0 font-13"></p>
            </div>
...
<!--end row-->
   ...
   <div class="row">
         ...
         <div class="card-body">
            <div class="d-flex align-items-center">
               <div>
                  <h6 class="mb-0">Taux d'abonnements</h6>
               </div>
            ...
            <div class="d-flex align-items-center ms-auto font-13 gap-2 my-3">
               <span class="border px-1 rounded cursor-pointer"><i class="bx bxs-circle me-1" style="color: #14abef"></i>Prestataires</span>
               <span class="border px-1 rounded cursor-pointer"><i class="bx bxs-circle me-1" style="color: #ffc107"></i>Clients</span>
            </div>
      ...
      <div class="col-12 col-lg-4">
            ...
            <ul class="list-group list-group-flush">
                  <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">Actifs <span class="badge bg-success rounded-pill">25</span>
                  </li>
                  <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">Rejetés <span class="badge bg-danger rounded-pill">10</span>
                  </li>
                  <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">Approuvés <span class="badge bg-primary rounded-pill">65</span>
                  </li>
                  <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">Inactif <span class="badge bg-warning text-dark rounded-pill">14</span>
                  </li>
            </ul>
         </div>
      </div>
   ...
   <!--end row-->
      ...
      <div class="row">
         ...
         <div class="card radius-10 w-100">
            <div class="card-header bg-transparent">
               <div class="d-flex align-items-center">
                  <div>
                     <h6 class="mb-0">Pourcentage d'activité par ville</h6>
                  </div>
                  <div class="dropdown ms-auto">
                     <a class="dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="dropdown"><i class='bx bx-dots-horizontal-rounded font-22 text-option'></i>
                     </a>
            ...
            <div class="card-body">
               ...
               <div class="col-lg-5 col-xl-4">
                  ...
                  <div class="mb-4">
                  <p class="mb-2"> Yaoundé <span class="float-end">70%</span></p>
                  ...
                  <div class="mb-4">
                  <p class="mb-2">Douala <span class="float-end">65%</span></p>
                  <div class="progress" style="height: 7px;">
                  ...
                  <div class="mb-4">
                  <p class="mb-2">Maroua <span class="float-end">60%</span></p>
                  <div class="progress" style="height: 7px;">
                  ...
                  <div class="mb-4">
                  <p class="mb-2">Garoua <span class="float-end">55%</span></p>
                  <div class="progress" style="height: 7px;">
                  ...
                  <div class="mb-4">
                  <p class="mb-2"> Ngaoundéré <span class="float-end">50%</span></p>
                  <div class="progress" style="height: 7px;">
                  ...
                  <div class="mb-0">
                     <p class="mb-2"> Buea<span class="float-end">45%</span></p>
                     <div class="progress" style="height: 7px;">
         ...
         <div class="col-12 col-lg-5 col-xl-4 d-flex">
            ...
            <div class="card radius-10 mb-0 border shadow-none">
               <div class="card-body">
                  <div class="d-flex align-items-center">
                     <div>
                        <p class="mb-0 text-secondary">Partages</p>
                        <h4 class="my-1">850</h4>
                        <p class="mb-0 font-13"></p>
                     </div>
      ...
      <div class="row row-cols-1 row-cols-lg-3">
         <div class="col d-flex">
                  <div class="card radius-10 w-100">
               <div class="card-body">
               <p class="font-weight-bold mb-1 text-secondary">Revenue de la semaine</p>
               <div class="d-flex align-items-center mb-4">
                  <div>
                     <h4 class="mb-0">20,540 FCFA</h4>
                  </div>
                  <div class="">
         ...
         <div class="col d-flex">
            <div class="card radius-10 w-100">
               <div class="card-header bg-transparent">
                  <div class="d-flex align-items-center">
                     <div>
                        <h6 class="mb-0">Details des transactions</h6>
                     </div>
                     <div class="dropdown ms-auto">
                        <a class="dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="dropdown"><i class='bx bx-dots-horizontal-rounded font-22 text-option'></i>
                        </a>
               ...
               <ul class="list-group list-group-flush">
                  <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">Terminées<span class="badge bg-gradient-quepal rounded-pill">25</span>
                  </li>
                  <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">En cours <span class="badge bg-gradient-ibiza rounded-pill">10</span>
                  </li>
                  <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">En attentes<span class="badge bg-gradient-deepblue rounded-pill">65</span>
                  </li>
               </ul>
            </div>
         </div>
         <div class="col d-flex">
            <div class="card radius-10 w-100">
               <div class="card-header bg-transparent">
                  <div class="d-flex align-items-center">
                     <div>
                        <h6 class="mb-0">Meilleures  Catégories</h6>
                     </div>
                     <div class="dropdown ms-auto">
                        <a class="dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="dropdown"><i class='bx bx-dots-horizontal-rounded font-22 text-option'></i>
                        </a>
               ...
               <div class="row row-group border-top g-0">
                  <div class="col">
                     <div class="p-3 text-center">
                        <h4 class="mb-0 text-danger">45,216 FCFA</h4>
                        <p class="mb-0">Beauté</p>
                     </div>
                  </div>
                  <div class="col">
                     <div class="p-3 text-center">
                        <h4 class="mb-0 text-success">68,154 FCFA</h4>
