<div class="page-content">
    ...
    <div class="alert border-0 border-start border-5 border-success alert-dismissible fade show py-2">
       <div class="d-flex align-items-center">
          ...
          <div class="ms-3">
             <h6 class="mb-0 text-success">SERVICE</h6>
             <div>CREATION D'UN NOUVEAU SERVICE</div>
          </div>
       </div>
    ...
    @endif
    <hr>
    <form class="" wire:submit.prevent="createNewService">
       @csrf
       <div class="col-lg-12">
          <div class="card">
              <div class="card-body">
                ...
                <div class="row mb-3">
                  ...
                  <div class="row">
                      ...
                      <div class="col-sm-9 text-secondary">
                        <button class="btn btn-success">Ajouter le service</button>    
                    </div>
                  </div>
              </div>
          </div>
